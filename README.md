...
6) `89e4b40`: removed redundant operations from `KeywordQueryEventListener.on_event` method
6) `current`: added keyword that allows to open the selected path in gnome-terminal
